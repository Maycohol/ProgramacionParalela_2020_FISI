/*
 ============================================================================
 Name        : prog03_pi_pthMutex.c
 Author      : Maycohol Jimmy Ayra Herrera
 Version     :
 Copyright   : Your copyright notice
 Description : Calculo de Pi utilizando pthread con pthread com mutex
 ============================================================================
 */
...
void* Thread_sum(void* rank) { //
   ...
   pthread_mutex_lock(&mutex); //estamos bloqueando
   sum += my_sum; //esto estamos bloqueando
