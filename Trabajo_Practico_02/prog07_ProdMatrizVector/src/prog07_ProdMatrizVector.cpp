/*
 ============================================================================
 Name        : prog07_ProdMatrizVector.cpp
 Author      : Maycohol Ayra Herrera
 Version     :
 Copyright   : Your copyright notice
 Description : Multiplicacion paralela de una matriz(NxN) con un vector(Nx1)
 ============================================================================
 */
#include <iostream>
#include <cstdlib>
...
int main(int argc, char * argv[]) {
    ...
    //Ingresamos el tamaño de la matriz por teclado
    ...
    MPI_Gather(&subFinal, // Dato que envia cada proceso
            rank_sz, // Numero de elementos que se envian
            MPI_LONG, // Tipo del dato que se envia
            y, // Vector en el que se recolectan los datos
            rank_sz, // Numero de datos que se esperan recibir por cada proceso
